...
enum METHOD_DETECTION {Right_Breakthorugh =1, Left_Breakthorugh =2, RandL_Breakthrough =3, RorL_Breakthrough =4};  // Detection methods to define a LD Bin is ready. Right_Breakthorugh (1) to compare R2(SNP_Breakthrough,SNP_Right) with the user configured parameter; Left_Breakthrough (2) to compare R2(SNP_Breakthrough,SNP_Left)
