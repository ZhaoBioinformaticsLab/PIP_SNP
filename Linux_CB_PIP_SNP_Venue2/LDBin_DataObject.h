...
*/
    ...
    void  Reset_LDBin_DataObject(int Line_Start, int Line_End);
    void  Add_one_markerline(int Line_Count, char * &markerline);
    ...
    CLDBin_DataObject(int Individual_Num, int Method_Corr, int Line_Strat, int Line_End);
